...
class AllContainerPacker:
    def __init__(self, image_list, container_list):
        ...
        self.containers_lds_out = join(self.CONTAINERS_BUILDDIR, "containers.lds")
        self.containers_S_out = join(self.CONTAINERS_BUILDDIR, "containers.S")
        self.containers_elf_out = join(self.CONTAINERS_BUILDDIR, "containers.elf")
    ...
    def pack_all(self, config):
        ...
        os.system(
            ...
            + "gcc "
            + "-nostdlib -o %s -T%s %s"
            % (self.containers_elf_out, self.containers_lds_out, self.containers_S_out)
        )
